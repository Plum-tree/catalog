...
// 一つのアイテムの詳細
// relationship databaseここは用復習
// 内部結合(inner join)が、テーブルの指定したフィールドの値が一致するデータしか抽出しないのに対し、
//外部結合(outer join)では、どちらかのテーブルにしか存在しないデータについても取得することができる
...
//        prepare文 - sql文を準備する
    ...
    //変数は参照としてバインドされ、PDOStatement::execute()がコールされたときのみ参照される。
...
// A, the, anとかを飛ばして、アルファベット順に並べるもの
